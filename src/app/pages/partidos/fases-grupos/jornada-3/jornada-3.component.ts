...
@Component({
  selector: 'app-jornada-3',
  standalone: true,
  imports: [
    CommonModule,
    ReactiveFormsModule
  ],
  templateUrl: './jornada-3.component.html',
})
export class Jornada3Component implements OnInit{
  ...
  if (
      ...
      localStorage.setItem('Jornada 3', JSON.stringify(this.resutadosj1))

      this.sc.emitirFGrupo(3)
    } else{
