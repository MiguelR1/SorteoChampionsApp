...
@Component({
  selector: 'app-jornada-4',
  standalone: true,
  imports: [
    CommonModule,
    ReactiveFormsModule
  ],
  templateUrl: './jornada-4.component.html',
})
export class Jornada4Component implements OnInit {
  ...
  if (
      ...
      localStorage.setItem('Jornada 4', JSON.stringify(this.resutadosj1))

      this.sc.emitirFGrupo(4)
    } else{
